    ...
    <NotificationProvider>
      <div className="flex flex-col lg:flex-row min-h-screen bg-slate-50/60 dark:bg-slate-950">
        ...
        <div className="flex-1 flex flex-col min-w-0 w-full">
          ...
          <header className="hidden lg:flex h-16 px-6 md:px-8 border-b border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-30 items-center justify-end">
            <NotificationTrigger />
          </header>
