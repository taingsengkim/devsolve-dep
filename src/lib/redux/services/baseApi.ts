...
export const baseApi = createApi({
  ...
  tagTypes: ["User", "Post", "Report", "Program", "Organization", "OrganizationMember", "CompanyVerification", "ContentReport", "ModerationItem", "AdminUser", "Notification", "Bookmark", "Profile", "Discussion"],
  endpoints: () => ({}),
});
