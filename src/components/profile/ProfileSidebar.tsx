  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="relative mx-auto aspect-square w-full max-w-[260px] overflow-hidden rounded-full border-2 border-slate-200/80 bg-slate-100 shadow-xs ring-4 ring-white dark:border-neutral-700 dark:bg-neutral-800 dark:ring-neutral-950 lg:mx-0">
          {avatarUrl ? (
        ...
        {isOwnProfile ? (
          <>
            ...
            <Link
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 shadow-2xs transition-colors hover:bg-slate-50 hover:text-slate-900 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800"
            >
              <Settings size={14} />
              Account settings
            </Link>
      ...
      <div className="space-y-1">
        <h1 className="text-xl font-bold leading-tight tracking-tight text-slate-900 wrap-break-word dark:text-neutral-100">
          {displayName}
        </h1>
      ...
      {bio && (
        <div className="prose prose-sm prose-slate dark:prose-invert text-sm leading-relaxed text-slate-600 dark:text-neutral-300 wrap-break-word">
      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
        <Link
          ...
          className="flex items-center gap-1 text-sm font-semibold text-slate-700 transition-colors hover:text-blue-600 dark:text-neutral-200 dark:hover:text-blue-400"
        >
          <Users size={14} className="text-slate-500 dark:text-neutral-400" />
          <span>
