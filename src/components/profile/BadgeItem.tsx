...
export default function BadgeItem({ badge }: BadgeItemProps) {
  ...
  return (
    <motion.div
      ...
      className={`flex flex-col items-center justify-center gap-2 rounded-xl border p-3 sm:p-3.5 text-center transition ${
        badge.locked
    ...
    >
      ...
      <div className="w-full">
        <p
          className={`text-xs sm:text-sm font-semibold leading-tight wrap-break-word ${
            badge.locked
        ...
        {badge.locked && (
          <p className="mt-0.5 text-xs font-medium text-slate-400 dark:text-neutral-500">
            Locked
          </p>
        )}
      </div>
