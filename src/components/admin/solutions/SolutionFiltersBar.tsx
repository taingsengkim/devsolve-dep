...
import { SolutionReviewStatus } from "@/lib/types/admin/solutionAdminTypes";

interface SolutionFiltersBarProps {
  statusFilter: SolutionReviewStatus | "ALL";
  onStatusFilterChange: (status: SolutionReviewStatus | "ALL") => void;
  searchQuery: string;
...
const TABS: {
  key: SolutionReviewStatus | "ALL";
  label: string;
  countKey: keyof SolutionFiltersBarProps["counts"];
}[] = [
...
export const SolutionFiltersBar: React.FC<SolutionFiltersBarProps> = ({
  statusFilter,
    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xs">
      ...
      <div className="relative w-full sm:w-80 shrink-0">
        ...
        <Input
          ...
          placeholder="Search solution ID or problem ID..."
