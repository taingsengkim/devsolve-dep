  ...
  return (
    <div ref={containerRef} className="relative w-full">
      <button
        ...
        className={cn(
          "w-full h-11 px-3.5 bg-slate-50/80 hover:bg-slate-100/90 border rounded-xl text-slate-900 text-sm flex items-center justify-between transition-all cursor-pointer outline-none focus:ring-2 focus:ring-blue-500/20",
          error
